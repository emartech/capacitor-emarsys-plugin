...
function addElement(): HTMLElement & { loadInApp(viewId: string): Promise<void> } {
  const inlineInapp = document.createElement(INLINE_IN_APP_TAG) as HTMLElement & { loadInApp(viewId: string): Promise<void> };
