...
# package.json inherits into the podspec at install time (CapacitorEmarsysPlugin.podspec
# reads package['version']), so package.json is the single iOS source of truth.
